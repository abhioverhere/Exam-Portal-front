      ...
      <AppBar position="static"  style={{backgroundColor:'#9c8a7d'}}>
        <StyledToolbar>        
          ...
          <Hidden mdUp>
            ...
            >
              <MenuItem>
                <Button color="inherit"><Link to={'/admindash'} style={{textDecoration:'none', color:'black'}}>Dashboard</Link></Button>
              </MenuItem>
              <MenuItem>                
                <Button color="inherit"><Link to={'/batches'} style={{textDecoration:'none', color:'black'}}>Batches</Link></Button>
              </MenuItem>
            </Menu>
            <Link href="/">
            <Box
